...
public class Pix extends AppCompatActivity {
    ...
    /**
     *
     * Call start(ActivityResultLauncher<Intent> activityResultLauncher, final FragmentActivity context, final Options options)
     *
     * Method receive in Activity
    ...
    /**
     *New Method for intent laucher
     *
     */
    public static void start(ActivityResultLauncher<Intent> activityResultLauncher, final FragmentActivity context, final Options options) {
